    ...
    public class LibTest
    {
        ...
        public class LibraryTests
        {
            ...
            public void Constructor_RemovesDuplicateReaders()
            {
                ...
                var reader2 = new Reader("Иван", "Иванов", "R001", "01.01.2023", 14, 500m); // Дубль

                var library = new Library("Центральная", "ул. Ленина, 1", new[] { reader1, reader2 });

                Assert.That(library.ReaderCount, Is.EqualTo(1));
            }

            [Test]
            public void IEnumerable_IteratesOverReaders()
            {
                var readers = new List<Reader>
        {
            new Reader("Анна", "Петрова", "R003", "03.01.2023", 30, 1000m)
        };

                var library = new Library("Философская", "ул. Канта, 5", readers);
